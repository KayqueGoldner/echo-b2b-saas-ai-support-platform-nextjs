...
export const ConversationsPanel = ({}: ConversationsPanelProps) => {
            ...
            {conversations.results.map((conversation) => {
              ...
              return (
                ...
                >
                  <div
                    className={cn(
                      "-translate-y-1.5 absolute top-1/2 left-0 h-[64%] w-1 rounded-r-full bg-neutral-300 opacity-0 transition-opacity",
                      pathname === `/conversations/${conversation._id}` &&
                        "opacity-100"
                    )}
                  />
